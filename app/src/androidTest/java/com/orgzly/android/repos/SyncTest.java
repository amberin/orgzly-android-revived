...
//    }
    ...
    public void testMockFileRename() throws IOException {
        ...
        assertEquals("Booky", BookName.fromRepoRelativePath(vrooks.get(0).getRepoRelativePath()).getName());
        ...
        assertEquals(1, vrooks.size());
        assertEquals("BookyRenamed", BookName.fromRepoRelativePath(vrooks.get(0).getRepoRelativePath()).getName());
    ...
    public void testDirectoryFileRename() throws IOException {
        ...
        assertEquals("notebook-renamed.org", repo.getBooks().get(0).getRepoRelativePath());
